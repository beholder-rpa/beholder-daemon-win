namespace beholder_eye
{
  ...
  public sealed class DesktopDuplicator
  {
    ...
    /// <summary>
    /// Duplicates the desktop which will yield Desktop Frames until cancelled.
    /// </summary>
    ...
    private sealed class DesktopDuplicatorInternal : IDisposable
    {
      ...
      public bool TryRetrieveFrame(out OutduplFrameInfo frameInformation)
      {
        ...
        try
        {
          // Keep in mind that DXGI will wait until the timeout for an *updated* frame.
          // If no changes occur within the timeout interval the corresponding result
          // will be returned.
        ...
        catch (SharpGenException ex)
        {
          ...
          if (ex.ResultCode.Failure
              && ex.Descriptor.NativeApiCode != "DXGI_ERROR_ACCESS_LOST"
